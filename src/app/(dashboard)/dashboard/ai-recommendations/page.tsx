  ...
  if (role !== "Manager") {
    return (
      <div className="flex flex-col items-center justify-center h-full text-center">
        ...
        <p className="text-muted-foreground">Only Managers can access AI recommendations.</p>
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 gap-6">
        <AIRecommendationsForm onSubmit={handleSubmit} isGenerating={isGenerating} defaultStoreName="SaleSpider Demo Store" />
        {isGenerating && (
          <div className="flex items-center justify-center p-8 rounded-md border border-dashed">
            ...
            <p className="text-muted-foreground">Generating recommendations, please wait...</p>
          </div>
        )}
