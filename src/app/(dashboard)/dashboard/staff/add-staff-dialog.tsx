  ...
  const handleSubmit = (data: AddStaffFormData) => {
    addStaffMutation.mutate(data, {
      onSuccess: responseData => {
        toast({
          title: 'Staff Added',
          description: `${(responseData as { name: string }).name} has been added successfully.`,
        })
    ...
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>{t('add_staff_description')}</DialogDescription>
        </DialogHeader>
        <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={value =>
                form.setValue('role', value as 'MANAGER' | 'CASHIER')
              }
            >
              <SelectTrigger>
