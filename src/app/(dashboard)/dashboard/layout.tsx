...
function CollapsibleSidebar() {
  ...
  return (
    <aside 
      className={`hidden border-r border-sidebar-border bg-sidebar text-sidebar-foreground md:block relative group transition-all duration-300 ${
    ...
    >
      <div className="flex flex-col h-full">
        ...
        <div className="sticky bottom-16 p-4 relative bg-sidebar">
          <SidebarToggle />
        </div>
        {/* Sidebar Footer Content - Sticky */}
        <div className="sticky bottom-0 p-4 border-t border-sidebar-border bg-sidebar">
          <p className={`text-xs text-sidebar-foreground/70 transition-opacity duration-300 ${
