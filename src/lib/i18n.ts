...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    auditLogsDescription: "Complete audit trail of all system activities and changes",
  ...
  fr: {
    ...
    auditLogsDescription: "Piste d'audit complète de toutes les activités et modifications du système",
  ...
  es: {
    ...
    auditLogsDescription: "Pista de auditoría completa de todas las actividades y cambios del sistema",
  ...
  de: {
    ...
    auditLogsDescription: "Vollständige Audit-Spur aller Systemaktivitäten und Änderungen",
