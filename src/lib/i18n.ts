...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    "this_year": "This Year",
    "manager_overview_description": "Here's an overview of your store's performance.",
    "cashier_overview_description": "Here's a summary of your sales activity.",
    // Breadcrumbs
    "dashboard": "Dashboard",
    "overview": "Overview",
    // Settings Descriptions
    "general_settings_description": "Configure basic application information and branding.",
    "appearance_settings_description": "Customize the application's color scheme and theme.",
    "currency_settings_description": "Configure the default currency for transactions and pricing.",
    "localization_settings_description": "Configure language, timezone, and date/time formats.",
    "system_settings_description": "Configure system-level preferences and maintenance options.",
    "maintenance_mode_description": "Enable maintenance mode to restrict access to the application.",
    // Search Placeholders
    "search_products": "Search products...",
    "search_staff": "Search staff by name, username, or role...",
    "search_sales_cashier": "Search sales by cashier, product, or payment mode...",
    "search_sales_product": "Search sales by product or payment mode...",
    "search_products_advanced": "Search by ID, name, category, price, GTIN, or description...",
    // Overview Components
    ...
    "record_sale_description": "Add products to the cart and complete the transaction.",
    // Inventory
    "products": "Products",
    ...
    "inventory_management_description": "View, add, and manage your product stock.",
    "inventory": "Inventory",
    ...
    "active": "Active",
    "inactive": "Inactive",
    "staff_management_description": "View staff details, performance, and manage their status.",
    ...
    "ai_recommendations_description": "Leverage AI to optimize your stock levels, identify promotional opportunities, and plan reorders.",
    // Messages
  ...
  fr: {
    ...
    "manager_overview_description": "Voici un aperçu des performances de votre magasin.",
    "cashier_overview_description": "Voici un résumé de votre activité de vente.",
    // Breadcrumbs
    "dashboard": "Tableau de bord",
    "overview": "Aperçu",
    // Settings Descriptions
    "general_settings_description": "Configurer les informations de base de l'application et la marque.",
    "appearance_settings_description": "Personnaliser le schéma de couleurs et le thème de l'application.",
    "currency_settings_description": "Configurer la devise par défaut pour les transactions et les prix.",
    "localization_settings_description": "Configurer la langue, le fuseau horaire et les formats de date et d'heure.",
    "system_settings_description": "Configurer les préférences au niveau du système et les options de maintenance.",
    "maintenance_mode_description": "Activer le mode maintenance pour restreindre l'accès à l'application.",
    // Search Placeholders
    "search_products": "Rechercher des produits...",
    "search_staff": "Rechercher du personnel par nom, nom d'utilisateur ou rôle...",
    "search_sales_cashier": "Rechercher des ventes par caissier, produit ou mode de paiement...",
    "search_sales_product": "Rechercher des ventes par produit ou mode de paiement...",
    "search_products_advanced": "Rechercher par ID, nom, catégorie, prix, GTIN ou description...",
    // Overview Components
    ...
    "record_sale_description": "Ajoutez des produits au panier et complétez la transaction.",
    // Inventaire
    "products": "Produits",
    ...
    "inventory_management_description": "Afficher, ajouter et gérer votre stock de produits.",
    ...
    "active": "Actif",
    "inactive": "Inactif",
    "staff_management_description": "Voir les détails du personnel, les performances et gérer leur statut.",
    ...
    "ai_recommendations_description": "Exploitez l'IA pour optimiser vos stocks, identifier les opportunités promotionnelles et planifier les réapprovisionnements.",
    // Messages
    "settings_updated": "Paramètres mis à jour",
    "settings_saved": "Les paramètres de l'application ont été enregistrés avec succès.",
    "failed_to_update": "Échec de la mise à jour des paramètres",
    "access_denied": "Accès refusé",
    "super_admin_only": "Seuls les super administrateurs peuvent accéder aux paramètres.",
  ...
  es: {
    ...
    "this_month": "Este mes",
    "this_year": "Este año",
    "manager_overview_description": "Aquí hay una visión general del rendimiento de su tienda.",
    "cashier_overview_description": "Aquí hay un resumen de su actividad de ventas.",
    // Breadcrumbs
    "dashboard": "Panel de control",
    "overview": "Resumen",
    // Settings Descriptions
    "general_settings_description": "Configurar información básica de la aplicación y la marca.",
    "appearance_settings_description": "Personalizar el esquema de colores y el tema de la aplicación.",
    "currency_settings_description": "Configurar la moneda por defecto para las transacciones y los precios.",
    "localization_settings_description": "Configurar el idioma, el fuso horario y los formatos de fecha y hora.",
    "system_settings_description": "Configurar las preferencias de nivel de sistema y las opciones de mantenimiento.",
    "maintenance_mode_description": "Activar el modo de mantenimiento para restringir el acceso a la aplicación.",
    // Search Placeholders
    "search_products": "Buscar productos...",
    "search_staff": "Buscar personal por nombre, usuario o rol...",
    "search_sales_cashier": "Buscar ventas por cajero, producto o modo de pago...",
    "search_sales_product": "Buscar ventas por producto o modo de pago...",
    "search_products_advanced": "Buscar por ID, nombre, categoría, precio, GTIN o descripción...",
    // Overview Components
    ...
    "record_sale_description": "Agregue productos al carrito y complete la transacción.",
    // Inventario
    "products": "Productos",
    ...
    "inventory_management_description": "Ver, agregar y administrar su stock de productos.",
    ...
    "active": "Activo",
    "inactive": "Inactivo",
    "staff_management_description": "Ver detalles del personal, rendimiento y gestionar su estado.",
    ...
    // IA
    "ai_insights": "Insights AI",
    "ai_recommendations_description": "Aproveche la IA para optimizar sus niveles de stock, identificar oportunidades promocionales y planificar reabastecimientos.",
    // Mensajes
    "settings_updated": "Configuración actualizada",
    "settings_saved": "La configuración de la aplicación se ha guardado correctamente.",
    "failed_to_update": "No se pudo actualizar la configuración",
    "access_denied": "Acceso denegado",
    "super_admin_only": "Solo los superadministradores pueden acceder a la configuración.",
  ...
  de: {
    ...
    "manager_overview_description": "Hier ist eine Übersicht über die Leistung Ihres Geschäfts.",
    "cashier_overview_description": "Hier ist eine Zusammenfassung Ihrer Verkaufsaktivität.",
    // Breadcrumbs
    "dashboard": "Dashboard",
    "overview": "Übersicht",
    // Settings Descriptions
    "general_settings_description": "Konfigurieren Sie grundlegende Anwendungsinformationen und Branding.",
    "appearance_settings_description": "Passen Sie das Farbschema und das Theme der Anwendung an.",
    "currency_settings_description": "Konfigurieren Sie die Standardwährung für Transaktionen und Preise.",
    "localization_settings_description": "Konfigurieren Sie Sprache, Zeitzone und Datums-/Zeitformate.",
    "system_settings_description": "Konfigurieren Sie systemweite Einstellungen und Wartungsoptionen.",
    "maintenance_mode_description": "Aktivieren Sie den Wartungsmodus, um den Zugriff auf die Anwendung zu beschränken.",
    // Search Placeholders
    "search_products": "Produkte suchen...",
    "search_staff": "Personal nach Name, Benutzername oder Rolle suchen...",
    "search_sales_cashier": "Verkäufe nach Kassierer, Produkt oder Zahlungsart suchen...",
    "search_sales_product": "Verkäufe nach Produkt oder Zahlungsart suchen...",
    "search_products_advanced": "Nach ID, Name, Kategorie, Preis, GTIN oder Beschreibung suchen...",
    // Overview Components
    ...
    "record_sale_description": "Fügen Sie Produkte zum Warenkorb hinzu und schließen Sie die Transaktion ab.",
    // Inventar
    "products": "Produkte",
    ...
    "inventory_management_description": "Anzeigen, Hinzufügen und Verwalten Ihres Produktbestands.",
    "inventory": "Inventar",
    ...
    "active": "Aktiv",
    "inactive": "Inaktiv",
    "staff_management_description": "Personaldetails, Leistung anzeigen und Status verwalten.",
    ...
    "add_staff_description": "Fügen Sie ein neues Personalmitglied zum System hinzu.",
    ...
    // KI
    "ai_insights": "Insights AI",
    "ai_recommendations_description": "Nutzen Sie KI, um Ihre Lagerbestände zu optimieren, Werbemöglichkeiten zu erkennen und Nachbestellungen zu planen.",
    // Nachrichten
    "settings_updated": "Einstellungen aktualisiert",
    "settings_saved": "Die Anwendungseinstellungen wurden erfolgreich gespeichert.",
    "failed_to_update": "Einstellungen konnten nicht aktualisiert werden",
    "access_denied": "Zugriff verweigert",
    "super_admin_only": "Nur Superadministratoren können auf die Einstellungen zugreifen.",
...
export function getTranslation(key: string, language?: string): string {
  ...
  const languageTranslations = translations[currentLanguage] || translations[DEFAULT_SETTINGS.language];
...
export function useDateTimeFormat() {
  try {
    ...
    return {
      formatDate: (date: Date) => formatDate(date, settings?.dateFormat, settings?.language),
