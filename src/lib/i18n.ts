...
const productDetailsDialogTranslations: Record<
  string,
...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    ai_insights_description:
      'Get AI-powered insights and recommendations based on your sales data',
    ai_insights_generated: 'AI Insights Generated',
    ai_insights_generated_description:
      'Fresh insights have been generated from your latest data.',
    ...
    ai_recommendations_description:
      'Based on your sales data from the last {days} days, here are AI-powered insights to optimize your inventory.',
    ...
    search_sales_product:
      'Search sales by sale ID, product, or payment mode...',
  ...
  fr: {
    ...
    ai_insights_description:
      "Obtenez des insights et des recommandations alimentés par l'IA basés sur vos données de vente",
    ai_insights_generated: 'Insights IA Générés',
    ai_insights_generated_description:
      'De nouveaux insights ont été générés à partir de vos dernières données.',
    ai_insights_failed:
      'Échec de la génération des insights IA. Veuillez réessayer.',
    ...
    generate_insights_description:
      'Cliquez sur le bouton "Générer des Insights" ci-dessus pour analyser les performances de votre magasin et obtenir des recommandations stratégiques.',
    // AI Recommendations Display
    ai_generated_recommendations: "Recommandations Générées par l'IA",
    ai_recommendations_description:
      "Basé sur vos données de vente des {days} derniers jours, voici des insights alimentés par l'IA pour optimiser votre inventaire.",
    ...
    update_stock_description: 'Entrez la quantité à ajouter au stock actuel.',
    ...
    auditLogsDescription:
      "Piste d'audit complète de toutes les activités et modifications du système",
  ...
  es: {
    ...
    ai_insights_description:
      'Obtenga insights y recomendaciones impulsados por IA basados en sus datos de ventas',
    ai_insights_generated: 'Insights de IA Generados',
    ai_insights_generated_description:
      'Se han generado nuevos insights a partir de sus datos más recientes.',
    ai_insights_failed:
      'Error al generar insights de IA. Por favor, inténtelo de nuevo.',
    ...
    generate_insights_description:
      'Haga clic en el botón "Generar Insights" arriba para analizar el rendimiento de su tienda y obtener recomendaciones estratégicas.',
    // AI Recommendations Display
    ai_generated_recommendations: 'Recomendaciones Generadas por IA',
    ai_recommendations_description:
      'Basado en sus datos de ventas de los últimos {days} días, aquí están los insights impulsados por IA para optimizar su inventario.',
    ...
    search_sales_product:
      'Buscar ventas por ID de venta, producto o modo de pago...',
    search_products_advanced:
    ...
    update_stock_description: 'Ingrese la cantidad a agregar al stock actual.',
    ...
    auditLogsDescription:
      'Pista de auditoría completa de todas las actividades y cambios del sistema',
    ...
    entity: 'Entidad',
    details: 'Detalles',
    deshelving: 'Desestantería',
    deshelve: 'Desestanteriar',
    restore: 'Restaurar',
    system: 'Sistema',
    changes: 'Cambios',
  ...
  de: {
    ...
    ai_insights_description:
      'Erhalten Sie KI-gestützte Einblicke und Empfehlungen basierend auf Ihren Verkaufsdaten',
    ai_insights_generated: 'KI-Einblicke Generiert',
    ai_insights_generated_description:
      'Neue Einblicke wurden aus Ihren neuesten Daten generiert.',
    ai_insights_failed:
      'Fehler beim Generieren von KI-Einblicken. Bitte versuchen Sie es erneut.',
    ...
    generate_insights_description:
      'Klicken Sie auf die Schaltfläche "Einblicke Generieren" oben, um die Leistung Ihres Geschäfts zu analysieren und strategische Empfehlungen zu erhalten.',
    // AI Recommendations Display
    ai_generated_recommendations: 'KI-Generierte Empfehlungen',
    ai_recommendations_description:
      'Basierend auf Ihren Verkaufsdaten der letzten {days} Tage, hier sind KI-gestützte Einblicke zur Optimierung Ihres Inventars.',
    ...
    search_sales_product:
      'Nach Verkaufs-ID, Produkt oder Zahlungsart suchen...',
    search_products_advanced:
    ...
    auditLogsDescription:
      'Vollständige Audit-Spur aller Systemaktivitäten und Änderungen',
    failedToLoadAuditLogs: 'Fehler beim Laden der Audit-Protokolle',
    loadingAuditLogs: 'Audit-Protokolle werden geladen',
    auditLogDetails: 'Audit-Protokoll Details',
