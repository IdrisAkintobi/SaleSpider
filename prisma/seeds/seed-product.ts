...
const CATEGORY_PRODUCTS = {
  [ProductCategory.FOOD_AND_BEVERAGES]: {
    ...
    products: ["Bread", "Milk", "Cheese", "Yogurt", "Coffee", "Tea", "Juice", "Water", "Soda", "Chips", "Cookies", "Cereal", "Rice", "Pasta", "Sauce"],
    priceRange: [500, 8500], // ₦500 - ₦8,500
    stockRange: [20, 500]
  },
  [ProductCategory.HOUSEHOLD_ITEMS]: {
    prefixes: ["Ultra", "Super", "Heavy Duty", "Eco-friendly", "Quick"],
    products: ["Detergent", "Soap", "Shampoo", "Towels", "Plates", "Cups", "Cutlery", "Vacuum", "Mop", "Broom", "Trash Bags", "Toilet Paper", "Paper Towels"],
  ...
  [ProductCategory.HEALTH_AND_BEAUTY]: {
    ...
    products: ["Moisturizer", "Sunscreen", "Lipstick", "Foundation", "Mascara", "Perfume", "Toothpaste", "Mouthwash", "Vitamins", "Pain Relief", "Bandages"],
    priceRange: [2500, 45000], // ₦2,500 - ₦45,000
    stockRange: [10, 150]
  },
  [ProductCategory.CLOTHING_AND_APPAREL]: {
    prefixes: ["Designer", "Casual", "Formal", "Sport", "Vintage"],
    products: ["T-Shirt", "Jeans", "Dress", "Jacket", "Shoes", "Socks", "Hat", "Belt", "Scarf", "Gloves", "Sweater", "Shorts", "Skirt"],
    priceRange: [3500, 85000], // ₦3,500 - ₦85,000
    stockRange: [5, 100]
  },
  [ProductCategory.ELECTRONICS]: {
    prefixes: ["Smart", "Wireless", "Digital", "High-Tech", "Pro", "Gaming", "Business", "Professional"],
    products: [
      "Smartphone", "iPhone", "Samsung Galaxy", "Android Phone",
      "Gaming Laptop", "Business Laptop", "MacBook", "Dell Laptop", "HP Laptop", "Lenovo ThinkPad",
      "iPad", "Tablet", "Android Tablet",
      "Wireless Headphones", "Gaming Headset", "AirPods", "Bluetooth Speaker", "Sound Bar",
      "USB Charger", "Wireless Charger", "Power Bank", "USB Cable", "HDMI Cable",
      "Wireless Mouse", "Gaming Mouse", "Mechanical Keyboard", "Wireless Keyboard",
      "4K Monitor", "Gaming Monitor", "Ultrawide Monitor", "LED TV", "Smart TV",
      "DSLR Camera", "Action Camera", "Web Camera", "Security Camera",
      "Smartwatch", "Fitness Tracker", "Apple Watch", "Samsung Watch"
    ],
  ...
  [ProductCategory.TOYS_AND_GAMES]: {
    ...
    products: ["Puzzle", "Board Game", "Action Figure", "Doll", "Building Blocks", "Car", "Ball", "Bike", "Scooter", "Art Set", "Musical Toy"],
    priceRange: [2500, 75000], // ₦2,500 - ₦75,000
    stockRange: [5, 100]
  },
  [ProductCategory.OFFICE_SUPPLIES]: {
    prefixes: ["Professional", "Premium", "Heavy Duty", "Ergonomic", "Multi-purpose"],
    products: ["Pen", "Pencil", "Notebook", "Folder", "Stapler", "Calculator", "Desk Lamp", "Chair", "Desk", "Printer", "Paper", "Binder"],
    priceRange: [800, 150000], // ₦800 - ₦150,000
    stockRange: [10, 200]
  },
  [ProductCategory.PET_SUPPLIES]: {
    prefixes: ["Premium", "Natural", "Healthy", "Deluxe", "Training"],
    products: ["Dog Food", "Cat Food", "Leash", "Collar", "Toy", "Bed", "Carrier", "Treats", "Shampoo", "Litter", "Bowl", "Brush"],
    priceRange: [2000, 40000], // ₦2,000 - ₦40,000
    stockRange: [8, 150]
  },
  [ProductCategory.AUTOMOTIVE]: {
    prefixes: ["High Performance", "Professional", "Heavy Duty", "Premium", "Universal"],
    products: ["Oil", "Filter", "Tire", "Battery", "Wiper", "Light", "Tool Set", "Jack", "Cleaner", "Polish", "Mat", "Cover"],
  ...
  [ProductCategory.BOOKS_AND_STATIONERY]: {
    ...
    products: ["Novel", "Textbook", "Journal", "Planner", "Pen Set", "Marker", "Highlighter", "Eraser", "Ruler", "Calendar", "Sticky Notes"],
  ...
  [ProductCategory.SEASONAL_AND_SPECIAL_OCCASIONS]: {
    ...
    products: ["Decoration", "Gift Wrap", "Card", "Candle", "Ornament", "Lights", "Wreath", "Garland", "Banner", "Balloon", "Party Supplies"],
    priceRange: [1000, 45000], // ₦1,000 - ₦45,000
    stockRange: [10, 200]
  },
  [ProductCategory.BABY_PRODUCTS]: {
    prefixes: ["Gentle", "Safe", "Organic", "Soft", "Hypoallergenic"],
    products: ["Diaper", "Formula", "Bottle", "Pacifier", "Blanket", "Toy", "Clothing", "Shampoo", "Lotion", "Stroller", "Car Seat", "High Chair"],
  ...
  [ProductCategory.SPORTS_AND_OUTDOORS]: {
    ...
    products: ["Ball", "Racket", "Weights", "Mat", "Tent", "Backpack", "Water Bottle", "Shoes", "Clothing", "Equipment", "Gear"],
    priceRange: [5000, 200000], // ₦5,000 - ₦200,000
    stockRange: [3, 80]
  },
  [ProductCategory.MEDIA]: {
    prefixes: ["Digital", "HD", "Premium", "Collector's", "Limited Edition"],
    products: ["DVD", "Blu-ray", "CD", "Vinyl", "Book", "Magazine", "Game", "Software", "Streaming", "Download"],
  ...
  [ProductCategory.OFFICE_AND_SCHOOL_SUPPLIES]: {
    ...
    products: ["Backpack", "Binder", "Calculator", "Pencil Case", "Lunch Box", "Water Bottle", "Notebook", "Art Supplies", "Glue", "Scissors"],
    priceRange: [1500, 45000], // ₦1,500 - ₦45,000
    stockRange: [10, 150]
  },
  [ProductCategory.GARDENING_AND_TOOLS]: {
    prefixes: ["Professional", "Heavy Duty", "Precision", "Ergonomic", "Multi-tool"],
    products: ["Hammer", "Screwdriver", "Wrench", "Drill", "Saw", "Pliers", "Seeds", "Fertilizer", "Pot", "Hose", "Shovel", "Rake"],
    priceRange: [4000, 100000], // ₦4,000 - ₦100,000
    stockRange: [5, 80]
  },
  [ProductCategory.JEWELRY_AND_WATCHES]: {
    prefixes: ["Elegant", "Luxury", "Designer", "Classic", "Modern"],
    products: ["Necklace", "Bracelet", "Ring", "Earrings", "Watch", "Pendant", "Chain", "Cufflinks", "Brooch", "Charm"],
  ...
  [ProductCategory.HEALTH_AND_FITNESS]: {
    ...
    products: ["Supplement", "Protein", "Equipment", "Monitor", "Scale", "Thermometer", "Blood Pressure", "Glucose", "First Aid", "Exercise"],
    priceRange: [5000, 150000], // ₦5,000 - ₦150,000
    stockRange: [5, 100]
  },
  [ProductCategory.OTHERS]: {
    prefixes: ["Universal", "Multi-purpose", "Specialty", "Custom", "Unique"],
    products: ["Gadget", "Tool", "Accessory", "Component", "Part", "Kit", "Set", "Device", "Equipment", "Item"],
...
function getProductImageUrl(category: ProductCategory, baseProduct: string): string {
  ...
  const imageMapping = {
    ...
    'iPhone': 'https://images.unsplash.com/photo-1592750475338-74b7b21085ab?w=300&h=300&fit=crop',
    'Samsung Galaxy': 'https://images.unsplash.com/photo-1610945415295-d9bbf067e59c?w=300&h=300&fit=crop',
    'Android Phone': 'https://images.unsplash.com/photo-1574944985070-8f3ebc6b79d2?w=300&h=300&fit=crop',
    'Gaming Laptop': 'https://images.unsplash.com/photo-1603302576837-37561b2e2302?w=300&h=300&fit=crop',
    'Business Laptop': 'https://images.unsplash.com/photo-1496181133206-80ce9b88a853?w=300&h=300&fit=crop',
    'MacBook': 'https://images.unsplash.com/photo-1517336714731-489689fd1ca8?w=300&h=300&fit=crop',
    'Dell Laptop': 'https://images.unsplash.com/photo-1588872657578-7efd1f1555ed?w=300&h=300&fit=crop',
    'HP Laptop': 'https://images.unsplash.com/photo-1541807084-5c52b6b3adef?w=300&h=300&fit=crop',
    'Lenovo ThinkPad': 'https://images.unsplash.com/photo-1484788984921-03950022c9ef?w=300&h=300&fit=crop',
    'iPad': 'https://images.unsplash.com/photo-1544244015-0df4b3ffc6b0?w=300&h=300&fit=crop',
    'Tablet': 'https://images.unsplash.com/photo-1561154464-82e9adf32764?w=300&h=300&fit=crop',
    'Android Tablet': 'https://images.unsplash.com/photo-1609081219090-a6d81d3085bf?w=300&h=300&fit=crop',
    'Wireless Headphones': 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=300&h=300&fit=crop',
    'Gaming Headset': 'https://images.unsplash.com/photo-1599669454699-248893623440?w=300&h=300&fit=crop',
    'AirPods': 'https://images.unsplash.com/photo-1600294037681-c80b4cb5b434?w=300&h=300&fit=crop',
    'Bluetooth Speaker': 'https://images.unsplash.com/photo-1608043152269-423dbba4e7e1?w=300&h=300&fit=crop',
    'Sound Bar': 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=300&h=300&fit=crop',
    'Smart TV': 'https://images.unsplash.com/photo-1593359677879-a4bb92f829d1?w=300&h=300&fit=crop',
    'LED TV': 'https://images.unsplash.com/photo-1567690187548-f07b1d7bf5a9?w=300&h=300&fit=crop',
    '4K Monitor': 'https://images.unsplash.com/photo-1527443224154-c4a3942d3acf?w=300&h=300&fit=crop',
    'Gaming Monitor': 'https://images.unsplash.com/photo-1616763355548-1b606f439f86?w=300&h=300&fit=crop',
    'Ultrawide Monitor': 'https://images.unsplash.com/photo-1547394765-185e1e68f34e?w=300&h=300&fit=crop',
    'Apple Watch': 'https://images.unsplash.com/photo-1551816230-ef5deaed4a26?w=300&h=300&fit=crop',
    'Samsung Watch': 'https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=300&h=300&fit=crop',
    'Smartwatch': 'https://images.unsplash.com/photo-1434493789847-2f02dc6ca35d?w=300&h=300&fit=crop',
    'Fitness Tracker': 'https://images.unsplash.com/photo-1575311373937-040b8e1fd5b6?w=300&h=300&fit=crop',
    'DSLR Camera': 'https://images.unsplash.com/photo-1502920917128-1aa500764cbd?w=300&h=300&fit=crop',
    'Action Camera': 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=300&h=300&fit=crop',
    'Web Camera': 'https://images.unsplash.com/photo-1587825140708-dfaf72ae4b04?w=300&h=300&fit=crop',
    'Security Camera': 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=300&h=300&fit=crop',
    'Gaming Mouse': 'https://images.unsplash.com/photo-1527864550417-7fd91fc51a46?w=300&h=300&fit=crop',
    'Wireless Mouse': 'https://images.unsplash.com/photo-1615663245857-ac93bb7c39e7?w=300&h=300&fit=crop',
    'Mechanical Keyboard': 'https://images.unsplash.com/photo-1541140532154-b024d705b90a?w=300&h=300&fit=crop',
    'Wireless Keyboard': 'https://images.unsplash.com/photo-1587829741301-dc798b83add3?w=300&h=300&fit=crop',
    'Power Bank': 'https://images.unsplash.com/photo-1609592806436-53dd2bd57d64?w=300&h=300&fit=crop',
    'Wireless Charger': 'https://images.unsplash.com/photo-1583394838336-acd977736f90?w=300&h=300&fit=crop',
    'USB Charger': 'https://images.unsplash.com/photo-1587829741301-dc798b83add3?w=300&h=300&fit=crop',
    ...
    'Juice': 'https://images.unsplash.com/photo-1560424072-74053d0bfcb0?w=300&h=300&fit=crop',
    'Water': 'https://images.unsplash.com/photo-1549484014-20c67c3e0b2b?w=300&h=300&fit=crop',
    ...
    'Jacket': 'https://images.unsplash.com/photo-1544966503-7cc5ac882d5e?w=300&h=300&fit=crop',

    // Health & Beauty
    'Moisturizer': 'https://images.unsplash.com/photo-1556228720-195a672e8a03?w=300&h=300&fit=crop',
    'Perfume': 'https://images.unsplash.com/photo-1541643600914-78b084683601?w=300&h=300&fit=crop',
    'Lipstick': 'https://images.unsplash.com/photo-1586495985345-b4d86b3df0ab?w=300&h=300&fit=crop',
    ...
    'Bicycle': 'https://images.unsplash.com/photo-1502744688674-c619d1586c9e?w=300&h=300&fit=crop',
  ...
  return categoryImages[category] || `https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=300&h=300&fit=crop&sig=${Math.random()}`;
}
...
function generateElectronicsPrice(baseProduct: string): number {
  ...
  const pricing = electronicspricing[baseProduct as keyof typeof electronicspricing];
  if (pricing) {
...
function generateProduct(index: number): any {
  ...
  const features = category === ProductCategory.ELECTRONICS
    ? ["high performance", "cutting-edge", "premium quality", "advanced features", "latest technology", "professional grade", "user-friendly", "reliable", "energy efficient", "sleek design"]
    : ["high quality", "durable", "lightweight", "easy to use", "premium", "reliable", "efficient", "comfortable", "stylish", "innovative", "eco-friendly", "affordable", "versatile", "professional", "portable"];
...
export async function seedProducts(client: PrismaClient, count: number = 1600) {
  ...
  for (let i = 0; i < count; i += batchSize) {
    ...
    try {
      ...
      console.log(`✅ Created products ${i + 1}-${i + currentBatchSize} (${createdCount}/${count})`);
      ...
      console.error(`❌ Error creating batch ${i + 1}-${i + currentBatchSize}:`, error);
    }
  }
