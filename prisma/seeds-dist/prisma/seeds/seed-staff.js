...
export async function seedStaff(client) {
    const staffData = [
        {
            id: "manager_001",
            name: "Idris Akintobi",
            username: "idrisakintobi",
            email: "idris.akintobi@salespider.local",
        ...
        },
        {
            ...
            name: "John Walker",
            username: "cashier1",
            email: "john.walker@salespider.local",
            password: "Password123#",
            role: Role.CASHIER,
            status: UserStatus.ACTIVE,
        },
        {
            ...
            name: "Charlie Brown",
            username: "cashier2",
            email: "charlie.brown@salespider.local",
            password: "Password123#",
            role: Role.CASHIER,
            status: UserStatus.ACTIVE,
        },
        {
            ...
            name: "Diana Prince",
            username: "cashier3",
            email: "diana.prince@salespider.local",
            password: "Password123#",
            role: Role.CASHIER,
